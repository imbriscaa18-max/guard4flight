...
import { Plane, Globe, TrendingDown, Search, Star, Zap, User } from "lucide-react"
          ...
          <div className="flex items-center gap-6 animate-slide-in-right">
            <SignedOut>
              <SignInButton mode="modal">
                <Button
                  variant="outline"
                  className="flex items-center gap-2 px-4 py-2 rounded-xl glass-card-modern hover-lift-modern bg-transparent"
                >
          ...
          <section className="mb-12 animate-fade-in-up animate-delay-200">
            <div className="glass-card-modern rounded-3xl p-8 hover-lift-modern text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Trebuie să te autentifici pentru a căuta prețuri la bilete de avion
              </p>
              <SignInButton mode="modal">
                <Button className="px-8 py-4 text-lg rounded-xl bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90">
                  <User className="w-5 h-5 mr-2" />
                  Conectează-te pentru a căuta
                </Button>
              </SignInButton>
            </div>
          </section>
